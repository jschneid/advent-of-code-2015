...
item_loadouts.each do |item_loadout|
  victory_loadouts << item_loadout if is_victory?(item_loadout, boss_enemy)
end

victory_loadouts.sort_by! { |loadout| loadout_cost(loadout) }

p victory_loadouts.first
p loadout_cost(victory_loadouts.first)
